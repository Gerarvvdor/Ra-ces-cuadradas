...
while len(paired_numbers) > 0:
    ...
    operacion_actual = int(operacion_actual) #se convierte a entero
    ...
    producto = int(temp_ans) * residuo #se multiplica el doble de la respuesta actual por el residuo

    operacion_actual -= producto
